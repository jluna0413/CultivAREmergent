    ...
    try:
        ...
        with app.app_context():
            ...
            try:
                ...
                target_user = db.session.get(User, admin_user.id)  # Removed keyword
                if target_user:
            ...
            try:
                ...
                if updated_user:
                    ...
                    print(f"  - Password hash: {updated_user.password_hash[:10]}...")
...
if __name__ == '__main__':
    success = test_password_update()
    if success:
        print("\n🎉 TEST COMPLETED SUCCESSFULLY!")
        print("✅ The password update functionality works correctly")
    else:
        print("\n❌ TEST FAILED!")
        print("❌ Issues found with password update functionality")
