...
def get_settings():
    ...
    try:
        ...
        formatted_settings = {
            ...
            'stream_grab_enabled': settings.get('stream_grab_enabled', 'false').lower() == 'true',
...
def save_settings(data):
    ...
    try:
        ...
        update_setting('stream_grab_enabled', str(data.get('stream_grab_enabled', False)).lower())
        update_setting('stream_grab_interval', str(data.get('stream_grab_interval', 3600)))
...
def upload_logo(file):
    ...
    try:
        ...
        return {'success': True, 'logo_path': os.path.join('uploads', 'logos', filename)}
    except Exception as e:
