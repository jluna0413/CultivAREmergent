...
### The Golden Rule: Task-Driven Development with Archon if Archon is not available use byterover as a secondary fallback, if byterover is not available use memory MCP.
...
- Use task-master-ai to plan and stucture task
- If available update all actions to Archon
- Move tasks from "todo" → "doing" → "review" (not directly to complete)
- Maintain task descriptions and add implementation notes
- DO NOT MAKE ASSUMPTIONS - check project documentation for questions

- Save patterns you learn that work to memory and byterover so you do not need to waste effort when approching similar issues in the future